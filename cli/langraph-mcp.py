...
PATH = "/Users/tadas/Projects/tilda/poc/turing-college/tvalai-AE.3.5/cli/"
...
if __name__ == "__main__":
    ...
    print("Starting LangGraph-Docs-MCP-Server...")
    mcp.run(transport="stdio")
    print("LangGraph-Docs-MCP-Server started successfully.")