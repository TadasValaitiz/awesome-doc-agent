...
class CodeInterpreterTool:
    ...
    def _get_installed_package_path() -> str:
        """Gets the installation path of the current package.
        ...
        # Return the parent directory (strategy_agent)
    ...
    def _check_docker_available(self) -> bool:
        ...
        try:
            ...
            server_logger.info("Docker is not installed", tags=["docker"])
            return False
    ...
    def run_code_in_docker(self, code: str, libraries_used: List[str]) -> str:
        ...
        """
        server_logger.info("Running code in Docker environment", tags=["docker"])
    ...
    def run_code_in_restricted_sandbox(self, code: str) -> str:
        ...
        """
        server_logger.info("Running code in restricted sandbox", tags=["sandbox"])
        exec_locals = {}
        try:
    ...
    def run_code_unsafe(self, code: str, libraries_used: List[str]) -> str:
        ...
        server_logger.info("WARNING: Running code in unsafe mode", tags=["unsafe"])
